...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#" onclick="getAllSubClassesOf()">getAllSubClassesOf</a>
                    </li>
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            <h3 ><i>Assistente de busca EOS</i></h3>
            
            <p>O Artigo possui as seguintes características</p>
            <!--   <p>O Artigo é um <select id="select_classes"></select></p> -->
        ...
        <!-- Page Features -->
       <div id="lista" class="row text-center">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyleft &copy; EOS Website 2015</p>
                </div>
            </div>
        </footer>
